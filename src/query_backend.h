...
enum DbTypes {
  ...
  MAP_STRING_MAP_STRING_PAIR_DOUBLE_VL_STRING, 
  MAP_STRING_MAP_VL_STRING_PAIR_DOUBLE_STRING, 
  MAP_STRING_MAP_VL_STRING_PAIR_DOUBLE_VL_STRING,
  MAP_STRING_VL_MAP_STRING_PAIR_DOUBLE_STRING, 
  MAP_STRING_VL_MAP_STRING_PAIR_DOUBLE_VL_STRING, 
  MAP_STRING_VL_MAP_VL_STRING_PAIR_DOUBLE_STRING, 
  MAP_STRING_VL_MAP_VL_STRING_PAIR_DOUBLE_VL_STRING, 
  MAP_VL_STRING_MAP_STRING_PAIR_DOUBLE_STRING,
  MAP_VL_STRING_MAP_STRING_PAIR_DOUBLE_VL_STRING,
  MAP_VL_STRING_MAP_VL_STRING_PAIR_DOUBLE_STRING,
  MAP_VL_STRING_VL_MAP_STRING_PAIR_DOUBLE_STRING,
  MAP_VL_STRING_MAP_VL_STRING_PAIR_DOUBLE_VL_STRING,
  MAP_VL_STRING_VL_MAP_STRING_PAIR_DOUBLE_VL_STRING,
  MAP_VL_STRING_VL_MAP_VL_STRING_PAIR_DOUBLE_VL_STRING,
  VL_MAP_STRING_MAP_STRING_PAIR_DOUBLE_STRING, 
  VL_MAP_STRING_MAP_STRING_PAIR_DOUBLE_VL_STRING,
  VL_MAP_STRING_MAP_VL_STRING_PAIR_DOUBLE_STRING,
  VL_MAP_STRING_VL_MAP_STRING_PAIR_DOUBLE_STRING,
  VL_MAP_VL_STRING_MAP_STRING_PAIR_DOUBLE_STRING, 
  VL_MAP_STRING_MAP_VL_STRING_PAIR_DOUBLE_VL_STRING,
  VL_MAP_STRING_VL_MAP_STRING_PAIR_DOUBLE_VL_STRING,
  VL_MAP_VL_STRING_MAP_STRING_PAIR_DOUBLE_VL_STRING,
  VL_MAP_STRING_VL_MAP_VL_STRING_PAIR_DOUBLE_STRING,
  VL_MAP_VL_STRING_MAP_VL_STRING_PAIR_DOUBLE_STRING,
  VL_MAP_VL_STRING_VL_MAP_STRING_PAIR_DOUBLE_STRING,
  VL_MAP_STRING_VL_MAP_VL_STRING_PAIR_DOUBLE_VL_STRING,
  VL_MAP_VL_STRING_MAP_VL_STRING_PAIR_DOUBLE_VL_STRING,
  VL_MAP_VL_STRING_VL_MAP_STRING_PAIR_DOUBLE_VL_STRING,
  VL_MAP_VL_STRING_VL_MAP_VL_STRING_PAIR_DOUBLE_STRING,
  VL_MAP_VL_STRING_VL_MAP_VL_STRING_PAIR_DOUBLE_VL_STRING,

  //pair<double,string>
  PAIR_DOUBLE_STRING, 
  PAIR_DOUBLE_VL_STRING,
